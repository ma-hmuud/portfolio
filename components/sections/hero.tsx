  ...
  return (
    <section className="min-h-screen flex flex-col justify-center pt-24 relative overflow-hidden bg-background">
      ...
      <div className="absolute bottom-1/4 left-0 w-full overflow-hidden opacity-5 pointer-events-none rotate-3">
        <div
          className="animate-marquee font-sans text-[8rem] md:text-[15rem] font-black leading-none whitespace-nowrap text-foreground"
      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-[7.5rem] font-black tracking-tighter mb-4 md:mb-6 uppercase">
              I'm <br />
              <span className="text-stroke">Mahmoud</span> Ahmed.
            </h1>
            ...
            <p className="text-lg md:text-xl lg:text-2xl font-mono text-muted-foreground leading-snug mb-8 md:mb-12 max-w-3xl border-l-4 border-accent pl-4 md:pl-6 bg-foreground/5 p-3 md:p-4">
              ...
              Next.js, Node.js, and TypeScript, with a strong background in
              optimizing backend performance and developing intuitive user
              interfaces.
            </p>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 md:gap-6">
              <Button
                asChild
                size="lg"
                className="w-full sm:w-auto rounded-none h-14 md:h-16 px-6 md:px-10 text-lg md:text-xl brutal-border brutal-shadow bg-primary text-primary-foreground hover:bg-accent hover:text-accent-foreground transition-none"
              >
                <Link href="#work">
                  VIEW PROJECTS
                  <ArrowUpRight
                    className="ml-2 md:ml-3 h-5 w-5 md:h-6 md:w-6"
                    strokeWidth={3}
                  />
                </Link>
              </Button>
              <Button
                ...
                variant="outline"
                size="lg"
                className="w-full sm:w-auto rounded-none h-14 md:h-16 px-6 md:px-10 text-lg md:text-xl brutal-border brutal-shadow bg-background text-foreground hover:bg-foreground hover:text-background transition-none"
              >
