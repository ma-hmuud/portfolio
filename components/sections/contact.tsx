...
export function Contact() {
  return (
    <section id="contact" className="py-32 relative bg-accent text-accent-foreground border-t-4 border-foreground overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-6xl md:text-8xl font-black mb-8 md:mb-12 uppercase tracking-tighter leading-[1] md:leading-[0.9]">
            READY TO BUILD SOMETHING <br />
            <span className="text-background" style={{ WebkitTextStroke: "2px var(--foreground)" }}>EXTRAORDINARY?</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-8 mb-16 md:mb-24 w-full px-4 sm:px-0">
            <Button asChild size="lg" className="w-full sm:w-auto rounded-none h-14 md:h-16 px-6 md:px-8 text-lg md:text-xl brutal-border brutal-shadow bg-foreground text-background hover:bg-background hover:text-foreground transition-none">
              <a href="mailto:mahmoud.ahmed.25.9.24@gmail.com">
                <Mail className="mr-2 md:mr-3 h-5 w-5 md:h-6 md:w-6" strokeWidth={3} />
                EMAIL ME
              </a>
            </Button>
            <Button asChild variant="outline" size="lg" className="w-full sm:w-auto rounded-none h-14 md:h-16 px-6 md:px-8 text-lg md:text-xl brutal-border brutal-shadow bg-background text-foreground hover:bg-foreground hover:text-background transition-none">
              <a href="tel:+201096389518">
                <Phone className="mr-2 md:mr-3 h-5 w-5 md:h-6 md:w-6" strokeWidth={3} />
                +20 109 638 9518
              </a>
            </Button>
          </div>
